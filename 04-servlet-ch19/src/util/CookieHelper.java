...
public class CookieHelper {
	...
	// 클라이언트에 있는 쿠키목록을 받아와서 cookieMap에 저장
	public CookieHelper(HttpServletRequest reg) {
	...
	/* key, 값, path, maxAge를 전달받아 Cookie 객체를 생성 
	   path : 해당 하위 경로까지 쿠키를 사용할 수 있다.
	   		예) cookie.setPath("/ch09"); -> /ch09 포함해서 이하경로까지 해당 쿠키를 사용할 수 있다. 
	   
	   maxAge : 해당 시간동안 cookie가 살아있게 설정하는 것 (초 단위 - 1시간: 60*60)
	   -1 : 무제한 / 0 : 삭제
	*/
	...
	/*
	 * domain
	 * 	예) cookie.setDomain(".koitt.com"); www.koitt.com, mail.koitt.com 등등의 도메인에서만 해당 쿠키를 사용할 수 있게 설정 
